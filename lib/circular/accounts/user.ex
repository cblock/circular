defmodule Circular.Accounts.User do
  @moduledoc false
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Circular.Repo)
  ...
  """
  def valid_password?(%Circular.Accounts.User{hashed_password: hashed_password}, password)
