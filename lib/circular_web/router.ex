defmodule CircularWeb.Router do
  use CircularWeb, :router

  import CircularWeb.UserAuth
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: CircularWeb.Telemetry
    end
  end
