defmodule CircularWeb.UserAuthTest do
  use CircularWeb.ConnCase, async: true

  alias Circular.Accounts
  alias CircularWeb.UserAuth
  import Circular.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CircularWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CircularWeb.Endpoint.subscribe(live_socket_id)
